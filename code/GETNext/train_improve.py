...
from model import GCN, GIN, NodeAttnMap, UserEmbeddings, Time2Vec, CategoryEmbeddings, FuseEmbeddings, TransformerModel
...
def train(args):
    ...
    embed_fuse_model1 = FuseEmbeddings(args.user_embed_dim, args.poi_embed_dim)#, hidden_dim=args.user_embed_dim+args.poi_embed_dim)
    embed_fuse_model2 = FuseEmbeddings(args.time_embed_dim, args.cat_embed_dim)#, hidden_dim=args.time_embed_dim+args.cat_embed_dim)
    ...
    optimizer = optim.AdamW(params=list(poi_embed_model.parameters()) +
